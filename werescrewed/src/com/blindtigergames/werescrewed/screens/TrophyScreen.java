...
public class TrophyScreen implements com.badlogic.gdx.Screen{
	...
	private Texture[] trophies1 = new Texture[trophyLength];  //trophy images that go next to player label
	...
	/**
	 * Keeps track of the different types of trophies.
	 * Consider rewriting as a hashmap or stack or something to 
	 *   optimize and prevent repeat trophies.
	 * 
	 * @param playerNum
	...
	private void trophyCheck ( int playerNum, int trophyNum, int index ) {
		switch ( trophyNum ) {
			case 1:  //Longest Running Time
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1RUNDIST ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2RUNDIST ) )
			...
			case 2:  //Most Struct Screws Unscrewed
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1UNSCREWED ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2UNSCREWED ) )
			...
			case 3:  //Longest Air Time
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1AIRTIME ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2AIRTIME ) )
			...
			case 4:  //Most Fall Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1FALLDEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2FALLDEATHS ) )
			...
			case 5:  //Most Time Spent On Puzzle Screws
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1PUZZLETIME ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2PUZZLETIME ) )
			...
			case 6:  //Most Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1DEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2DEATHS ) )
			...
			case 7:  //Most Head Jumps
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1HEADSTANDS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2HEADSTANDS ) )
			...
			case 8:  //Most Revives
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1REVIVES ) > 
			...
			case 9:  //Most Secondary Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1TEAMDEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2TEAMDEATHS ) )
			...
			case 10: //Longest Idle Time
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1IDLETIME ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2IDLETIME ) )
			...
			case 12: //Most Crush Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1CRUSHDEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2CRUSHDEATHS ) )
			...
			case 13: //Most Electrocution Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1ELECDEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2ELECDEATHS ) )
			...
			case 14: //Longest Time Grounded
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1GROUNDTIME ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2GROUNDTIME ) )
			...
			case 15: //Most Jumps
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1JUMPS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2JUMPS ) )
			...
			case 16: //Most Spike Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1SPIKEDEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2SPIKEDEATHS ) )
			...
			case 17: //Most Fire Deaths
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1FIREDEATHS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2FIREDEATHS ) )
			...
			case 18: //Longest Time Dead
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1DEADTIME ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2DEADTIME ) )
			...
			case 19: //Most Steam Jumps
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1STEAMJUMPS ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2STEAMJUMPS ) )
			...
			case 20: //Most Strip Screws Attached To
				if ( playerNum == 1 && 
					Metrics.getTrophyMetric( TrophyMetric.P1STRIPATTACH ) > 
						Metrics.getTrophyMetric( TrophyMetric.P2STRIPATTACH ) )
			...
			case 23: //Random 3
				if ( playerNum == 1 ) {
					player1[index] = new Label( "You Unlocked An Achievement!!", font );
				}
				else if ( playerNum == 2 ) {
					player2[index] = new Label( "You Unlocked An Achievement!!", font );
				}
				break;
			case 24: //Random 4
				if ( playerNum == 1 ) {
			...
			case 26: //Random 6
				if ( playerNum == 1 ) {
					player1[index] = new Label( "Better Than Bacon Ice Cream", font );
				}
				else if ( playerNum == 2 ) {
					player2[index] = new Label( "Better Than Bacon Ice Cream", font );
				}
				break;
			case 27: //Random 7
				if ( playerNum == 1 ) {
					player1[index] = new Label( "You Played The Best Game Ever!!", font );
				}
				else if ( playerNum == 2 ) {
					player2[index] = new Label( "You Played The Best Game Ever!!", font );
				}
				break;
			case 28: //Random 8
				if ( playerNum == 1 ) {
