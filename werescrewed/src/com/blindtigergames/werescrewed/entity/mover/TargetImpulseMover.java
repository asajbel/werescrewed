...
public class TargetImpulseMover implements IMover {
	...
	/**
	 * Impulse will start to slow down once the body you're trying to move is within this radius.
	 */
	public float minImpulseRadius;
	private float minImpulseRadiusSquared;

	/**
	 * Full constructor to build a mover that targets a dynamic body to a certain position.
	 * @param targetPixel
	 * @param impulsePoint
