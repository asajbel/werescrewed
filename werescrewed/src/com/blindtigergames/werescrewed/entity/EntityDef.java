	...
	public static EntityDef getDefinition(String id){
		if (definitions.containsKey(id)){
			...
			if (id.equals("player")){ //Player
				...
				FixtureDef playerFixtureDef = makeFixtureDef(9.9f, 0.05f, 0.5f, playerfeetShape);			
		        fixes.add(playerFixtureDef);
		        
				out = new EntityDef("player", new Texture(Gdx.files.internal("data/player_r_m.png")), "", playerBodyDef, fixes);
				...
				out = EntityDef.loadDefinition(id); //Otherwise, try loading from XML.
	        }
			if (out != null)
